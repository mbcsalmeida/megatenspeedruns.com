...
<Tabs>
    ...
    <Steps>
        ...
        5. On 2024/08/05, sioneus updated the world record with a time of [**1:36:24**](https://youtu.be/cp-_HLaqo1Y).
        6. The current world record is held by fujikura123 with a time of [**1:14:28**](). This run uses a new route that uses the casino trick.
    </Steps>
    </TabItem>
</Tabs>
...
<details>
<summary>**Casino Trick**</summary>

Can be used in both Dark and Light versions. When playing BIG OR SMALL, if you hold down the L button, the result will always be a tie. This means that you can tie the game indefinitely while waiting for a 0 or 9 to appear which will always result in a win if choosing Big or Small, respectively.
</details>

## Notes
- [Dark Version - Casino Route](https://sioneus.me/notes/demikids-dark-casino/) - sioneus
- [Dark Version](https://pastebin.com/n04ZmGMp) - lilfatkid
- [Light Version](https://sioneus.me/notes/demikids-light) - sioneus
